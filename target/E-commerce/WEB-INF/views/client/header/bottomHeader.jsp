...
<!--                <a href="index.jsp">
              ...
              <div class="aa-shipping-box">
                  <a class="aa-shipping-boxsmall">
                      ...
                      <div class="">Khu vực TP DaNang</div>
                      </span>
                  ...
                  <a class="aa-shipping-boxsmall">
                      ...
                      <span class="aa-shipping-box-text">
                          <div class="aa-shipping-title">Hỗ trợ: 084.311.0207</div>
              ...
              <div class="aa-cartbox">
                <a class="aa-cart-link" href="${pageContext.request.contextPath}/views/client/cart">
                ...
                <div class="aa-cartbox-summary">
                  ...
                  <c:forEach items="${order.items}" var="item" >
                    <li>
                      <a class="aa-cartbox-img" href="${pageContext.request.contextPath}/views/client/cart"><img src="${pageContext.request.contextPath}/resources/client/assets/images/products/img-test/${item.product.image_link}" alt="img"></a>
                      <div class="aa-cartbox-info">
                        <h4><a href="${pageContext.request.contextPath}/views/client/cart">${item.product.name}</a></h4>
                  ...
                  <a class="aa-cartbox-checkout aa-primary-btn" href="${pageContext.request.contextPath}/views/client/cart">Chi tiết</a>
                  <a class="aa-cartbox-checkout aa-primary-btn" href="${pageContext.request.contextPath}/views/client/checkout">Thanh toán</a>
                </div>
              </div>
              <!-- / cart box -->
