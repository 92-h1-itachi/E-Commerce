            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-left">
                <div class="cellphone hidden-xs">
                  <p><span class="fas fa-home"></span>Hàng Xách Tay Nhật Bản</p>
                </div>
                <!-- start language -->
...
<!--                <div class="cellphone hidden-xs">
              ...
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
					...
					<li class="hidden-xs"><a href="<c:url value = "/logout"/>">Đăng xuất</a></li>
					</c:if>
				 <c:if test="${sessionScope.username == null}">
	                  <li class="hidden-xs"><a href="<c:url value = "/register"/>">Đăng ký</a></li>
