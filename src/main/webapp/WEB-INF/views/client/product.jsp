            ...
            <div class="aa-product-catg-body">
              <ul class="aa-product-catg">
                ...
                <c:forEach items="${productlist}" var="product">
	                <li>
	                  <figure>
	                    <a class="aa-product-img" href="${pageContext.request.contextPath}/view/client/product-detail?id=${product.id}"><img src="${url}/images/products/img-test/${product.image_link}" alt="${product.name}"></a>
              ...
              <div class="aa-recently-views">
                <ul>
                 <c:forEach items="${productlist}" var="product" end="2">
                  <li>
                    <a href="${url}/images/products/img-test/${product.image_link}"></a>
