            ...
            <div class="row">
              ...
              <div class="col-md-8 col-md-push-2">
                <div class="aa-myaccount-register">                 
                 <h4>Đăng ký</h4>
                 <form:form name="formRegister" class="aa-login-form" method="get" modelAttribute="user" action="register-add" >
                    <form:hidden path="id" />
                    ...
                    <form:input path="email" type="text"  id="email" name="email"  placeholder="useremail@gmail.com"/>
                    <form:errors path="email" cssStyle="color: #ff0000"/>
                   
                    <label for="">Số điện thoại<span>*</span></label>
                    <form:input path="phone" type="text"  id="phone" name="phone"  placeholder="Số điện thoại" />
                    ...
                    <form:input path="created" type="date" style="display: none" id="the-date" name="created"  placeholder="Password"/>
                   ...
                   <%--  <p style="color:red; display: block;"><%=(request.getAttribute("errMessage") == null) ? ""
			        ...
			        : request.getAttribute("Message")%></p>       --%>
			         <form:button type="reset" class="aa-browse-btn" value="Reset">Đặt lại</form:button>  
                      <form:button type="submit" class="aa-browse-btn">Đăng ký</form:button>                         
                  </form:form>
                </div>
              </div>
            </div>          
