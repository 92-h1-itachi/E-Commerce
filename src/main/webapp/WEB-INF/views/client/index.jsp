                                ...
                                <div class="tab-pane fade in active" id="raucu">
                                    <ul class="aa-product-catg">
                                        ...
                                        <c:forEach items="${product_raucu}" var="product" end="7">
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="${pageContext.request.contextPath}/views/client/product-detail?id=${product.id}"><img src="${pageContext.request.contextPath}/view/client/assets/images/products/img-test/${product.image_link}" alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="${pageContext.request.contextPath}/views/client/add-cart?product-id=${product.id}"><span class="fa fa-shopping-cart"></span>Thêm vào giỏ hàng</a>
                                                    <figcaption>
...
<!-- / Client Brand -->
<!--  footer-->
<jsp:include page = "/WEB-INF/views/client/footer/footer.jsp" flush = "true" />
<!-- end footer-->
